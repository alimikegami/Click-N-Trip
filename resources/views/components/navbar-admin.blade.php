   ...
   <nav id="sidebar">
        <ul class="list-unstyled components">
            ...
            <li id="dashboard-icons">
                <a href="/admins/dashboard/tour-guide-applications"><i  class="bi bi-briefcase-fill  px-2"></i><span class="fw-bold side-navlinks">Tour Guide Apllicant List</span></a>
            </li>
            <li id="dashboard-icons">
                <a href="/admins/dashboard/users"><i class="bi bi-people-fill  px-2"></i><span class="fw-bold side-navlinks">User List</span></a>
            </li>
            <li id="dashboard-icons">
                <a href="/admins/dashboard/payment-details"><i class="bi bi-credit-card  px-2"></i><span class="fw-bold side-navlinks">Pending User Payment</span></a>
            </li>
            <li id="dashboard-icons">
