...
@section('body')
    ...
    <div class="container mt-5">
        <div class="row mb-5" id='header'>
            <h1 class='text-center' id='tourpostheadertitle'>Edit Day Trip Plan</h1>
        </div>
        <div class='row'>
            <div class="container">
                <form action="/day-trips" method="post" class='register-form pt-5' enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-center">
                        <button id='create-button' type='button' onclick="addRow()" class="btn btn-secondary">Add
                            Schedule</button>
                    </div>
                    ...
                    <div class="d-flex justify-content-center pb-5">
                        <button id='create-button' type="submit" class="btn btn-primary mt-3">Edit</button>
                    </div>
                </form>
            </div>
        </div>
